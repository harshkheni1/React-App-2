...
const PatientInfo = () => {
    ...
    if (doctorNote || patientNote) {
      if (noteId) {
        const updatePaylod = {
          ...
          doctorid: userData?.selectedRole.ID,
        }
        try {
  ...
  const getPreiviousNotes = async () => {
    try {
      // const preiviousNotesData = await GET(`note?appoinmentId=${id}`)
      const preiviousNotesData = await GET(`note/${userData?.selectedRole.ID}/${patientData?.id}`)

      console.log(preiviousNotesData)
  ...
  const getPatientDetails = async () => {
    try {
      ...
      const appointPatient = await GET(`patient/${id}`)

      console.log(appointPatient, 'appointPatientappointPatient')
      setPatientData(appointPatient?.data[0])
      setDataLoading(false)

      if (appointPatient?.data[0]?.patientData === null) {
  ...
  function onSocketConnected() {
    ...
    console.log('callRequest: ', currentCallRequest)
  ...
  const changeAppointmentStatus = (appoinmentStatus) => {
  ...
  const addEmployeeClaims = async (claimStatus) => {
    ...
    const body = {
      ...
      costamount: patientData.doctorService.servicecost,
      paidamount: patientData.doctorService.servicecost,
  ...
  return (
    <div>
      ...
      >
        <TabPane tab="Patient Detail" key="1">
          {patientDetail1 ? (
            <div>
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-5 ml-n5">
                          <div className={style.card_header_new}>
                            <HeadersCardHeader data={{ title: 'Patient Details' }} />
                          </div>
                          <div>
                            {/* <Tag
                      ...
                      <div className="col-md-4">
                        <div className="ml-4">
                          <p>
                            ...
                            <span>{patientData?.Insurancesvcnum || 'N/A'}</span>
                          </p>
                        </div>
                      </div>
                      <div className="col-md-4">
                      ...
                      <div className="col-md-4">
                        <div className="ml-4">
                          <p>
                            ...
                            <span>{patientData?.familyphysician || 'N/A'}</span>
                          </p>
                        </div>
                      </div>
                      {/* phone Number code */}
                      <div className="col-md-4">
                        <div className="ml-4">
                          <p>
                            ...
                            <span>{patientData?.phone || '+1 11255455'} </span>
                          </p>
                        </div>
                      </div>
                      {/* end */}
                      ...
                      <div className="col-md-4">
                        <div className="ml-4">
                          <p>
                            ...
                            <span>{patientData?.province || 'British Columbia'}</span>
                          </p>
                        </div>
                      </div>
                      <div className="col-md-4">
                        <div className="ml-4">
                          <p>
                            ...
                            <span>{patientData?.ohip || '5584-486-674-YM'} </span>
                          </p>
                        </div>
                      </div>
                      <div className="col-md-4">
                  ...
                  <div className="card card-top card-top-primary">
                    <div className="card-body">
                      <Tabs defaultActiveKey="1" size="large" onChange={changeTab}>
                        ...
                        <TabPane tab="Doctor's Notes" key="DOCTOR">
            ...
            <h2 className="mt-5 pt-5 text-center">Patient Not Found</h2>
          )}
        </TabPane>
      ...
      <Modal
        title="Do you want to confirm or Reject the Appointment"
